class MgAdmissionSettingsController < ApplicationController
  layout "mindcom"
...
if admission_setting.empty?
  ...
  def mg_admission_settings_params
    params.require(:mg_admission_setting).permit(:start_date, :end_date, :mg_time_table_id, :mg_school_id, :updated_by, :created_by, :is_deleted)
  end
end
